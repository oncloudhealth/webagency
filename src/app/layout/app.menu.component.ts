        ...
        this.model = [
            {
                ...
                items: [
                    ...
                    { label: 'Scheduling', icon: 'pi pi-fw pi-home', routerLink: ['/scheduling'] },
                    { label: 'Schedules Approval', icon: 'pi pi-fw pi-home', routerLink: ['/scheduling/approval'] },
                    { label: 'Timesheet', icon: 'pi pi-fw pi-home', routerLink: ['/scheduling/timesheet'] },
                    { label: 'Manual Timesheet Entry', icon: 'pi pi-fw pi-home', routerLink: ['/scheduling/manual-timesheet'] },
                    { label: 'Manual Clock In/Out', icon: 'pi pi-fw pi-home', routerLink: ['/scheduling/manual-clock-in-out'] }
                ]
            },
            {
                label: 'Billing',
            ...
            //         },
            //         {
            //             label: 'View Source', icon: 'pi pi-fw pi-search', url: ['https://github.com/primefaces/OnCloudHealth-ng'], target: '_blank'
            //         }
            //     ]
            // }
        ];
